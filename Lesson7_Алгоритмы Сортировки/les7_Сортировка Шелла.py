# Выбираем шаг для сравнения элементов (1,4,10,23,57,132,301,701,1750) до 4000элементов
# Сравниваем последовательно элементы находящиеся на расстоянии шага
# уменьшаем шаг и повторяем
